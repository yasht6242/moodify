...
function printQues() {
  document.getElementById("quesid").innerHTML =
    "Q" + itemOperations.itemList[i].id;
  document.getElementById("ques").innerHTML = itemOperations.itemList[i].ques;
  document.getElementById("input1").innerHTML =
    itemOperations.itemList[i].option1;
  document.getElementById("input2").innerHTML =
    itemOperations.itemList[i].option2;
  document.getElementById("input3").innerHTML =
    itemOperations.itemList[i].option3;
  document.getElementById("input4").innerHTML =
    itemOperations.itemList[i].option4;
